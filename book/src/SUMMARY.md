...
- [Modelling with Diffsol](./primer/modelling_with_diffsol.md)
  ...
  - [Hybrid ODEs](./primer/hybrid.md)
    - [Example: Dosing Protocols](./primer/dosing_protocols.md)
    - [Example: Epidemic SIR with policy switching](./primer/sir_policy_switching.md)
